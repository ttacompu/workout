 ...
 */
(function () {
    angular.module("workoutApp").controller("workoutController", ['$scope', '$interval', '$location', 'workoutHistoryTracker', 'appEvents', 'workoutService', '$routeParams', 'Exercise', function ($scope, $interval, $location, workoutHistoryTracker, appEvents, workoutService, $routeParams, Exercise) {
        ...
        $scope.onKeyPressed = function (event) {
            if (event.which == 32 || event.which == 112) {        // 'p' or 'P' key to toggle pause and resume.
